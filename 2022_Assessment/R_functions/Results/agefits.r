AgeFits <- function(dat=test,case_label="2014 assessment",f=1,ages=c(1,15)) {
   subtle.color <- "gray40"
...
AgeFitsSrv <- function(dat=mod1, main="",case_label="2011 assessment",f=1,rec_age=2,ages=c(1,15)) {
   subtle.color <- "gray40"
   attach(dat)
   #ages <- c(1,15) #age range
