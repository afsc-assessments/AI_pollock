...
AFSC=odbcConnect("AFSC","sbarb","BluFsh!Fog8",believeNRows=FALSE)
...
filled.contour(akima.li,color=col,xlim=c(1979,2019),
                   panel.last=(list(abline(v=2018,lty=2,col="red"),
                   abline(v=2016,lty=2,col="red"),
                   abline(v=2014,lty=2,col="red"),
                   abline(v=2012,lty=2,col="red"),g
...
akima.li <- interp(haul$YEAR, haul$RLONG, log(haul$CPUE), duplicate="mean",
...
data1<-Get_DATA(username="sbarb",password="BluFsh!Fog8",survey = c("52"),yr=c(1980:2018))
