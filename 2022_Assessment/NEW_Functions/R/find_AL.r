...
find_AL<-function(Adata,Ldata,year){
 ...
 #rb.age1.1<-lencat(rb.age1,"tl",startcat=50,w=50)
  #rb.age2.1<-lencat(rb.age2,"tl",startcat=50,w=50)
 rb.age1.1<-lencat(x=~tl,data=rb.age1,startcat=50,w=50)
 rb.age2.1<-lencat(x=~tl,data=rb.age2,startcat=50,w=50)
